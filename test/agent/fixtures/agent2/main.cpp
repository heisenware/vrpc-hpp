...
namespace vrpc {
  ...
  VRPC_CTOR(Bar)
  VRPC_CTOR(Bar, int)
  VRPC_STATIC_FUNCTION(Bar, int, staticIncrement, int)
  VRPC_STATIC_FUNCTION(Bar, void, staticCallback, VRPC_CALLBACK(int), int)
  VRPC_MEMBER_FUNCTION(Bar, void, onValue, VRPC_CALLBACK(int))
  VRPC_MEMBER_FUNCTION(Bar, int, increment)
  VRPC_MEMBER_FUNCTION(Bar, void, reset)
  VRPC_MEMBER_FUNCTION(Bar, void, callback, VRPC_CALLBACK(int), int)
}
