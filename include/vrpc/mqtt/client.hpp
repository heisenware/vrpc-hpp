...
#include <vrpc/mqtt/variant.hpp> // should be top to configure variant limit
...
#include <vrpc/mqtt/endpoint.hpp>
#include <vrpc/mqtt/null_strand.hpp>
#include <vrpc/mqtt/move.hpp>
#include <vrpc/mqtt/constant.hpp>
