...
#include <vrpc/mqtt/config.hpp> // should be top to configure variant limit
...
#include <vrpc/mqtt/tcp_endpoint.hpp>
#include <vrpc/mqtt/shared_scope_guard.hpp>
#include <vrpc/mqtt/message_variant.hpp>
#include <vrpc/mqtt/two_byte_util.hpp>
#include <vrpc/mqtt/four_byte_util.hpp>
#include <vrpc/mqtt/packet_id_type.hpp>
#include <vrpc/mqtt/optional.hpp>
#include <vrpc/mqtt/property_variant.hpp>
#include <vrpc/mqtt/protocol_version.hpp>
#include <vrpc/mqtt/reason_code.hpp>
#include <vrpc/mqtt/buffer.hpp>
#include <vrpc/mqtt/shared_ptr_array.hpp>
#include <vrpc/mqtt/type_erased_socket.hpp>
#include <vrpc/mqtt/move.hpp>
#include <vrpc/mqtt/deprecated.hpp>
#include <vrpc/mqtt/deprecated_msg.hpp>
#include <vrpc/mqtt/error_code.hpp>
#include <vrpc/mqtt/log.hpp>
#include <vrpc/mqtt/variant_visit.hpp>
#include <vrpc/mqtt/topic_alias_send.hpp>
#include <vrpc/mqtt/topic_alias_recv.hpp>
#include <vrpc/mqtt/subscribe_entry.hpp>
#include <vrpc/mqtt/shared_subscriptions.hpp>
#include <vrpc/mqtt/packet_id_manager.hpp>

#if defined(MQTT_USE_WS)
#include <vrpc/mqtt/ws_endpoint.hpp>
